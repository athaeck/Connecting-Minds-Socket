...
class SetPlacedItemsEndpoint extends BaseNoSQLExpressRouteExtension {
  dbName: string;
  private _collectionName: string = "PlacedItems";

  constructor() {
    super("/world/placedItems/set", ExpressRouteType.POST);
    this.dbName = "World";
  }
...
module.exports = SetPlacedItemsEndpoint;
